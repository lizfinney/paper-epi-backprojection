...
def reformat(npz_file):
    ...
    for i in range(len(count_vec)):
        ...
        df_dict[f'df_{i}_ref'] = pd.DataFrame(vec_table)
...
def extract_vec_npz(npz_file, npz_base_name, PROJ_DIR):
...
def main():
    ...
    extract_vec_npz(npz_file, npz_base_name, PROJ_DIR)
