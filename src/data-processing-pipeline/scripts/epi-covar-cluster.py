...
def trajectory_calc(df, mutant_sites_samp, d=5):
...
def main(args):
    ...
    #freq = freqs_from_counts(counts, total_seqs, window=delta_t, min_seqs=min_seqs)
    #trajectory_calc(nVec, sVec, ref_sites, d=q)
