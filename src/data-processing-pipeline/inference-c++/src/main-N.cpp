...
/*********************************************************************
 ...
 -n: string
    The location of the file containing the population size at each
    observed generation. If no input is given, the population size
 ...
 -N: real number
    Default: 1.0e4
    Population size, if the population size is approximately constant.
...
int main(int argc, char *argv[]) {
    ...
    for (int i=1;i<argc;i++) {
        ...
        // else if (strcmp(argv[i],"-n")==0)  { if (++i==argc) break; else { r.NInfile  = argv[i]; r.useN      = true; } }
