...
void updateCovarianceIntegrate(double dg, double alpha, const std::vector<double> &p1_0, const std::vector<double> &p2_0, const std::vector<double> &p1_1, const std::vector<double> &p2_1, double totalCov[]);
...
void updateMuIntegrate(double dg, double alpha, const Vector &muMatrix, const std::vector<double> &p1_0, const std::vector<double> &p1_1, std::vector<double> &totalMu);
